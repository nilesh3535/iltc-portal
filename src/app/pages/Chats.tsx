...
export function Chats() {
  ...
  const mockChatMessages = [
    {
      id: '1',
      senderId: 'staff',
      content: 'Hi Emma! How can I help you today?',
      timestamp: '10:30 AM',
    },
    {
      id: '2',
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h3 className="text-xl text-gray-800">Individual Chats</h3>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm text-gray-900 truncate">{traveller.name}</p>
                      <p className="text-xs text-gray-500">{traveller.mobile}</p>
                    </div>
            ...
            {selectedTraveller ? (
              <>
                ...
                <div className="p-4 border-b border-gray-200 flex items-center gap-3">
                  <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white">
                    {mockTravellers.find((t) => t.id === selectedTraveller)?.name.charAt(0)}
                  </div>
                  <div>
                    <p className="text-sm text-gray-900">
                      {mockTravellers.find((t) => t.id === selectedTraveller)?.name}
                    </p>
                ...
                <div className="flex-1 overflow-y-auto p-4 bg-gray-50 space-y-4">
                  {mockChatMessages.map((msg) => (
                    <div
                      key={msg.id}
                      className={`flex ${
                        msg.senderId === 'staff' ? 'justify-end' : 'justify-start'
                      }`}
                    >
                      <div
              ...
              <div className="flex items-center justify-center h-full text-gray-500">
                <div className="text-center">
                  <p className="text-lg mb-2">Select a traveller to start chatting</p>
