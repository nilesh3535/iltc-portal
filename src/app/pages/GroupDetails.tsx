...
import { ArrowLeft, Plus, Edit2, Trash2, Download, Upload, Copy, Share2, MessageSquare, FileText, Users, Settings, Send } from 'lucide-react';
import { mockGroups, mockTravellers, mockMessages, mockDocuments } from '../utils/mockData';
...
export function GroupDetails() {
  ...
  const [activeTab, setActiveTab] = useState<'travellers' | 'chat' | 'private-chats' | 'documents' | 'settings'>('travellers');
  ...
  const tabs = [
    ...
    { id: 'private-chats', label: 'Private Chats', icon: <MessageSquare size={18} /> },
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-sm text-gray-700">Mobile</th>
                      <th className="px-4 py-3 text-left text-sm text-gray-700">Invite Status</th>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {travellers.map((traveller) => (
                      <tr key={traveller.id} className="hover:bg-gray-50">
                        <td className="px-4 py-3 text-sm text-gray-900">{traveller.name}</td>
                        <td className="px-4 py-3 text-sm text-gray-600">{traveller.mobile}</td>
              ...
              <div className="bg-gray-50 rounded-lg p-4 h-96 overflow-y-auto space-y-4">
                {messages.map((msg) => (
                  ...
                  >
                    ...
                    >
                      <p className="text-xs mb-1 opacity-75">{msg.senderName}</p>
                      <p className="text-sm">{msg.content}</p>
                      {msg.fileName && (
                        <div className="mt-2 text-xs opacity-75">📎 {msg.fileName}</div>
                      )}
          ...
          {activeTab === 'private-chats' && (
            <div className="grid grid-cols-3 gap-4 h-96">
              <div className="border-r pr-4">
                <h4 className="text-sm text-gray-700 mb-4">Travellers</h4>
              ...
              <div className="col-span-2">
                <div className="text-center text-gray-500 py-12">
                  Select a traveller to view private chat
                </div>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Input label="Start Date" type="date" value={group.startDate} />
      ...
      >
        <div className="space-y-4">
          ...
          <Input
            ...
            onChange={(e) => setTravellerForm({ ...travellerForm, mobile: e.target.value })}
            placeholder="Enter mobile number"
          />
          <div className="flex justify-end gap-3">
            <Button variant="secondary" onClick={() => setIsAddTravellerOpen(false)}>
              Cancel
            </Button>
