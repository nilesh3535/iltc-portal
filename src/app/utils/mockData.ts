import { TourGroup, Traveller, Message, Document, Staff, DashboardMetrics, Broadcast } from '../types';
...
export const mockBroadcasts: Broadcast[] = [
  {
    id: '1',
    groupId: '1',
    message: 'Reminder: Tour starts in 7 days! Please ensure all documents are ready.',
